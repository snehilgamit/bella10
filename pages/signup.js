        ...
        <>
                <div className='w-full flex justify-center min-h-[60vh] mt-[10rem] max-sm:mt-12 max-sm:px-3'>
                    <div className='overflow-hidden w-[700px] min-h-[50vh] max-sm:flex-col border-2 rounded-3xl flex justify-center items-start'>
                        ...
                        <form onSubmit={(e)=>{e.preventDefault()}} className="w-[50%] max-sm:w-full h-full flex flex-col justify-start items-center p-7 relative text-center">
                            ...
                            <div className='mt-3 text-2xl bg-black text-white cursor-pointer min-w-[100px] mb-10 text-center py-1 rounded-lg max-sm:mb-4 hover:opacity-60 font-semibold' onClick={signup}>
                                {signupTxt}
                            </div>
                            </div>
                        </form>
